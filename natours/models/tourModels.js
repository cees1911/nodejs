...
const tourSchema = new mongoose.Schema(
  {
    name: {
      ...
      // laat geen spaces toe dus niet erg handig
    },
    slug: String,
    duration: {
      type: Number,
    ...
    priceDiscount: {
      ...
      validate: {
        validator: function (val) {
          // this. work only on a new document
          return val < this.price;
        },
        message: 'Discount can not > than price ({VALUE})',
      },
    },
    summary: {
      type: String,
